...
We have implemented secure environment variable management for API keys.
...
2. Edit `.env` and add your OpenAI API key:
   ...
   ```
3. In Xcode, add `ConfigManager.swift` to your project if it's not already included.
